...
image:
  path: /assets/img/posts/2026-05-29/newsletter-update-example.svg
  alt: Masanam blog 업데이트 뉴스레터 예시
---
...
<div class="subscribe-modal subscribe-modal-example" role="img" aria-label="구독 모달 예시">
  <section class="subscribe-modal__dialog" role="dialog" aria-modal="false" aria-labelledby="subscribe-modal-example-title">
    <button class="subscribe-modal__close" type="button" aria-label="닫기">
      <i class="fas fa-times" aria-hidden="true"></i>
    </button>

    <div class="subscribe-modal__badge">
      <i class="fas fa-paper-plane" aria-hidden="true"></i>
    </div>

    <p class="subscribe-modal__eyebrow">Masanam Newsletter</p>
    <div id="subscribe-modal-example-title" class="subscribe-modal__title">블로그 업데이트를 메일로 받아보세요</div>
    <p class="subscribe-modal__description">
      블로그의 새로운 글과 최신 BI 연구 논문 리뷰, 관련 동향을 담은 뉴스레터를 이메일로 받아보실 수 있습니다.
    </p>

    <div class="subscribe-modal__features" aria-label="구독 내용">
      <span><i class="fas fa-pen-nib" aria-hidden="true"></i> 새 글 업데이트</span>
      <span><i class="fas fa-dna" aria-hidden="true"></i> BI 연구 논문 리뷰</span>
      <span><i class="fas fa-chart-line" aria-hidden="true"></i> 동향 뉴스레터</span>
    </div>

    <form class="subscribe-modal__form">
      <label class="subscribe-modal__label" for="subscribe-email-example">이메일 주소</label>
      <div class="subscribe-modal__row">
        <input
          id="subscribe-email-example"
          class="subscribe-modal__input"
          type="email"
          placeholder="email@example.com"
          disabled
        >
        <button class="subscribe-modal__submit" type="button">
          구독하기
        </button>
      </div>
      <p class="subscribe-modal__message">
        확인 메일을 누르면 구독이 완료됩니다.
      </p>
    </form>
  </section>
</div>
...
<p class="newsletter-email-example">
  <img
    src="/assets/img/posts/2026-05-29/newsletter-update-example.svg"
    alt="Masanam blog 업데이트 뉴스레터 예시"
  >
</p>

<style>
  .subscribe-modal-example {
    position: relative;
    inset: auto;
    z-index: auto;
    display: block;
  ...
  .subscribe-modal-example .subscribe-modal__dialog {
    margin: 0;
  }

  .subscribe-modal-example .subscribe-modal__title {
    margin: 0;
    color: #ffffff;
    font-size: 1.55rem;
    font-weight: 700;
  ...
  .subscribe-modal-example .subscribe-modal__input:disabled {
    opacity: 1;
  }

  .newsletter-email-example img {
    display: block;
    width: 100%;
    height: auto;
